...
$alphaLemonCmsPath = __DIR__ . '/../vendor/alphalemon/alphalemon-cms-bundle/AlphaLemon/AlphaLemonCmsBundle';
require_once $alphaLemonCmsPath . '/Tests/Tools/AlphaLemonPropelQuickBuilder.php';
if (class_exists('TypehintableBehavior')) {
    ...
    $builder->setSchema(file_get_contents($alphaLemonCmsPath . '/Resources/config/schema.xml'));
